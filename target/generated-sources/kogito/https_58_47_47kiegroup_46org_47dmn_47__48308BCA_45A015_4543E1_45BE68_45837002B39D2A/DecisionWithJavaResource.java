 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__48308BCA_45A015_4543E1_45BE68_45837002B39D2A;
...
@Path("/DecisionWithJava")
public class DecisionWithJavaResource {
    ...
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSetDecisionWithJava")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/OutputSetDecisionWithJava")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_48308BCA-A015-43E1-BE68-837002B39D2A", "DecisionWithJava");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_48308BCA-A015-43E1-BE68-837002B39D2A", "DecisionWithJava", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("DecisionWithJava") + ".dmn_nologic")));
    }
